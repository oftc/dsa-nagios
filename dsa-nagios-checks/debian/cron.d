...
@hourly  root [ -x /sbin/iptables-save ] && umask 0177; /sbin/iptables-save | sed -e 's/\[.*//' -e 's/^#.*//' | sha256sum > /var/run/iptables-online.checksum
@hourly  root [ -x /sbin/ip6tables-save ] && umask 0177; /sbin/ip6tables-save | sed -e 's/\[.*//' -e 's/^#.*//' | sha256sum > /var/run/ip6tables-online.checksum
